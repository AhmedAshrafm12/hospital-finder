...
>(({ className, inset, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      {children}
      <ChevronRight className={`${language === 'ar' ? 'mr-auto rotate-180' : 'ml-auto'} h-4 w-4`} />
    </DropdownMenuPrimitive.SubTrigger>
  )
})
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        inset && (language === 'ar' ? "pr-8" : "pl-8"),
        language === 'ar' ? "text-right justify-end" : "text-left justify-start",
        className
      )}
      {...props}
    />
...
>(({ className, children, checked, ...props }, ref) => {
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      {...props}
    >
      <span className={`absolute ${language === 'ar' ? 'right-2' : 'left-2'} flex h-3.5 w-3.5 items-center justify-center`}>
